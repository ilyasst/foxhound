    ...
    *,
    ...
    try:
        ...
        if config.task_work_root is not None and config.task_kb_root is not None:
            ...
            origin_payload = TaskLedger(config.database_path).bound_candidate_payload(claim.task_id)
            ...
            archive = prepare_task_archive(
                ...
                origin_sources=stored_origin_sources(origin_payload) if origin_payload else (),
            )
