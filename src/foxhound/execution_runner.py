...
def agent_prompt(worker_command: str = "foxhound-task-worker") -> str:
    ...
    return "\n".join((
        ...
        "Set `schema` to `foxhound.execution-result-draft`, `schema_version` to 1, and `result_id` to the same 32 lowercase hex characters used in the filename. Collections are arrays of strings.",
